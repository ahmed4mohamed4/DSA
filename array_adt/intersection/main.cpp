...
struct Array intersection_not_sorted_arrays (const Array &arr1, const Array &arr2) {
    /*
        n * m
        O(n * m)
        O(n ^ 2)
    */
    int k = 0, n = arr1.length, m = arr2.length;
...
struct Array intersection_sorted_arrays (const Array &arr1, const Array &arr2) {
    /*
        O(n + m)
        O(n)
    */
...
int main () {
    ...
    arr3 = intersection_not_sorted_arrays (arr1, arr2);
